...
6. **Currency**: All monetary values are in **BDT (৳)**.
  ...
  paths: {
    ...
    '/cart': {
      get: {
        tags: ['Shopping Cart'],
        summary: 'Get Live Shopping Cart',
        description: 'Returns cart items with server-validated prices, stock status, active flash deal pricing, and savings calculation.',
        responses: { '200': { description: 'Live cart summary' } },
      },
      delete: {
        tags: ['Shopping Cart'],
    ...
    '/wishlist': {
      get: {
        ...
        security: [{ BearerAuth: [] }],
        responses: { '200': { description: 'Wishlisted products list' } },
      },
    },
    '/wishlist/{productId}': {
      post: {
        ...
        responses: { '200': { description: 'Wishlist status toggled' } },
      },
      delete: {
        tags: ['Wishlist'],
    ...
    '/deals/friday-flash': {
      get: {
        tags: ['Deals & Flash Sales'],
        summary: 'Active Friday Flash Deal Campaign',
        description: 'Returns active flash deals, allocated vs sold stock, remaining quantities, and real-time countdown timer.',
        responses: { '200': { description: 'Active Friday Flash Deal' } },
      },
    },
    '/deals/deals-of-the-day': {
      get: {
        tags: ['Deals & Flash Sales'],
        summary: 'Deals of the Day',
        description: 'Discounted daily grocery essentials with verified stock.',
        responses: { '200': { description: 'Deals of the day' } },
      },
    },
    '/coupons/validate': {
      post: {
        ...
        description: 'Verifies active dates, min order amounts, user usage limits, and calculates exact discount amount.',
        requestBody: {
          required: true,
          content: {
            'application/json': {
              schema: {
                ...
                properties: {
                  code: { type: 'string', example: 'RAMADAN20' },
                  subtotal: { type: 'number', example: 850 },
    ...
    '/checkout/preview': {
      post: {
        tags: ['Checkout & Pricing Engine'],
        summary: 'Server-Side Price Authority Checkout Preview',
        description: 'Calculates verified subtotal, coupon discount, delivery fee, tax and payable grand total. Client values are never trusted.',
        requestBody: {
          required: false,
          content: {
            'application/json': {
        ...
        responses: { '200': { description: 'Calculated checkout totals breakdown' } },
      },
    },
    '/settings': {
      get: {
        ...
        description: 'Delivery fee rates, free shipping thresholds, currency, tax.',
